   ...
   <div class="container medium">
      <div class="row">
         ...
         <div class="flex-col">
            ...
            <li><p>The Netherlands ©</p></li>            <li><p>2021</p></li>
         </div>
      </div>
   </div>
</section>
         ...
         <div class="flex-col">
            <div class="btn-wrap theme-dark">
               <div class="btn btn-round" data-scroll data-scroll-speed="2"  data-scroll-position="top">
                  <a href="https://onenil.com/" target="_blank" class="btn-click magnetic " data-strength="100" data-strength-text="50">
                     <div class="btn-fill"></div>
                     <span class="btn-text">
...
</section><section class="section single-block block-mobile-devices block_1" data-scroll-section style="background-color: #dfdfdf;">
...
<section class="section single-block block-fullwidth block_2" data-scroll-section>
...
</section><section class="section single-block block-device block_3 block-padding-bottom "  data-scroll-section>
   <div class="container">
      <div class="row device-mbp16lower">
         <div class="flex-col">
            <div class="device">
...
</section><section class="section single-block block-device block_4 block-padding-bottom " style="background-color: #dfdfdf;" data-scroll-section>
   <div class="container">
   ...
   <div class="rounded-div-wrap">
      <div class="rounded-div" style="background-color: #dfdfdf;"></div>
   </div>
</div>
