   ...
   <div class="container medium">
      <div class="row">
         ...
         <div class="flex-col">
            ...
            <li><p>Design: G2O Brand Builders</p></li><li><p>Copy: Jessie Voois</p></li>         </div>
         <div class="flex-col">
            <h5>Location & year</h5>            <div class="stripe"></div>
            <li><p>The Netherlands ©</p></li>            <li><p>2022</p></li>
         </div>
      </div>
   </div>
</section>
         ...
         <div class="flex-col">
            <div class="btn-wrap theme-dark">
               <div class="btn btn-round" data-scroll data-scroll-speed="2"  data-scroll-position="top">
                  <a href="https://chainn.nl/" target="_blank" class="btn-click magnetic " data-strength="100" data-strength-text="50">
                     <div class="btn-fill"></div>
                     <span class="btn-text">
